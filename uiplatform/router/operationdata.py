...
class CaseInfo(Resource):
    ...
    def post(self):
        ...
        """
        parser = reqparse.RequestParser()
        parser.add_argument('name', type=str, required=True, help='测试结果')
        parser.add_argument('description', type=str)
        parser.add_argument('type', type=str)
        parser.add_argument('deptid', type=str, required=True)
        parser.add_argument('function_type', type=str)
        parser.add_argument('page_class_type', type=str)
        parser.add_argument('source_url', type=str)
        parser.add_argument('devices_type', type=str)
        parser.add_argument('update_by', required=True, type=str)
        parser.add_argument('create_by', required=True, type=str)
        args = parser.parse_args()
        model = Uicaseinfo()
...
class CaseElement(Resource):
    ...
    def post(self):
        ...
        """
        parser = reqparse.RequestParser()
        parser.add_argument('type', type=str, required=True, help='测试结果')
        parser.add_argument('remark', type=str)
        parser.add_argument('assert_text', type=str)
        parser.add_argument('key', type=str, required=True)
        parser.add_argument('name', type=str)
        parser.add_argument('value', type=str)
        parser.add_argument('page_class', type=str)
